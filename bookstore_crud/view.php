...
<head>
	...
	<title>View Books - Bookstore</title>
</head>
	...
	<div class="container my-5">
		<div class="p-5 text-center bg-body-tertiary rounded-3">
			<div class="bi mt-4 mb-3" width="100" height="100">
				<img class="bookstore-main-icon" src="images/icons8-books-96.png" style="width: 64px; max-width: 96px;" alt="Bookstore Icon" />
			</div>
			<p class="col-lg-8 mx-auto fs-5 text-muted">Library</p>
